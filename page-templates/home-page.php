...
<main id="primary" class="site-main">
        ...
        <div class="projects-container">
            ...
            <div class="projects__desc">
                <div class="projects-container display-start-col">
                    <div class="desc-wrap"><p><?php getAcfValue("upcoming_events_description");?></p></div>
                    <div class="list-wrap">
                        <ul class="project__list">
                            <li><?php getAcfValue("upcoming_events_list_1");?></p></li>
                            <li><?php getAcfValue("upcoming_events_list_2");?></p></li>
                            <li><?php getAcfValue("upcoming_events_list_3");?></p></li>
                            <li><?php getAcfValue("upcoming_events_list_4");?></p></li>
                            <li><?php getAcfValue("upcoming_events_list_5");?></p></li>
                        </ul>
                    </div>
                </div>
            </div>
    ...
    <section class="projects mb center-items-col">
        ...
        <div class="desc-wrap"><p class="mb-text"><?php getAcfValue("upcoming_events_description");?></p></div>
        <div class="list-wrap">
            <ul class="project__list">
                <li><?php getAcfValue("upcoming_events_list_1");?></p></li>
                <li><?php getAcfValue("upcoming_events_list_2");?></p></li>
