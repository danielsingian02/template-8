            ...
            <div class="col-sec flex">
                <div class="row-wrap">
                    ...
                    <div class="list-wrap flex">
                        <div class="list-icon"><img src="<?= get_stylesheet_directory_uri(); ?>../assets/images/icon_list.png" class="list__icon-"/></div><div class="info-list"><p><?php getAcfValue("list_1");?></p></div>
                    </div>
                    <div class="list-wrap flex">
                        <div class="list-icon"><img src="<?= get_stylesheet_directory_uri(); ?>../assets/images/icon_list.png" class="list__icon-"/></div><div class="info-list"><p><?php getAcfValue("list_2");?></p></div>
                    </div>
                    <div class="list-wrap flex">
                        <div class="list-icon"><img src="<?= get_stylesheet_directory_uri(); ?>../assets/images/icon_list.png" class="list__icon-"/></div><div class="info-list"><p><?php getAcfValue("list_3");?></p></div>
                    </div>
                </div>
